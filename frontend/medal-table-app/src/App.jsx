...
export default function App() {
    ...
    document.addEventListener("DOMContentLoaded", loadData("/gold"));
        ...
        <div id="page">
            ...
            <div className="content">
                ...
                <div className="sub-header sequence-buttons">
                    <SequenceButton image={false} content={"A-Z"} arrow={true} />
                    <SequenceButton image={false} content={"A-Z"} arrow={false} />
                    <SequenceButton image={true} content={"https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Gold_medal.svg/1024px-Gold_medal.svg.png"} arrow={true} />
                    <SequenceButton image={true} content={"https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Gold_medal.svg/1024px-Gold_medal.svg.png"} arrow={false} />
                    <SequenceButton image={true} content={"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/GoldSilverBronze_medals.svg/1920px-GoldSilverBronze_medals.svg.png"} arrow={true} />
                    <SequenceButton image={true} content={"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/GoldSilverBronze_medals.svg/1920px-GoldSilverBronze_medals.svg.png"} arrow={false} />
                </div>
